...
New-Item "hklm:\\SYSTEM\CurrentControlSet\Services\mrxsmb10" -name Start -Value 4 -Force
...
New-item "hklm:\\Software\Policies\Microsoft\Edge" -name HideFirstRunExperience -Value 1 -Force

New-Item "hklm:\\Software\Policies\Microsoft\Internet Explorer\Main" -Name DisableFirstRunCustomize -Value 1 -Force
